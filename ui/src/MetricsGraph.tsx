    ...
    return (
        <Grid2 container sx={{ flexGrow: 1, p: 1 }} alignItems="center">
            ...
            <LineChart width={560} height={200} slotProps={{ legend: {hidden: true}}} grid={{ vertical: true, horizontal: true }} series={[
                    { data: rxData, label: "rx", color: COLORS.metrics, area: true, stack: "total", showMark: false, valueFormatter: (v) => { return bytesToSize(v as number) } },
                    { data: txData, label: "tx", color: COLORS.secondary, area: true, stack: "total", showMark: false, valueFormatter: (v) => { return bytesToSize(v as number) } }
                ]}
