...
class UnshareRequest {
    /**
     * Constructs a new <code>UnshareRequest</code>.
    ...
    /**
     * Constructs a <code>UnshareRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UnshareRequest} obj Optional instance to populate.
     * @return {module:model/UnshareRequest} The populated <code>UnshareRequest</code> instance.
     */
    ...
    /**
     * Validates the JSON data with respect to <code>UnshareRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UnshareRequest</code>.
     */
