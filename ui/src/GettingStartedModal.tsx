...
const GettingStartedModal = ({ close, isOpen }: GettingStartedModalProps) => {
    ...
    const checkedSx = { color: 'success.main' };
    const uncheckedSx = {};
    ...
    return (
        <Modal open={isOpen} onClose={close} aria-labelledby="modal-title-getting-started">
            <Box sx={{ ...modalStyle }}>
                ...
                <Grid2 container sx={{ flexGrow: 1, p: 1 }} alignItems="center">
                    <Typography>
                        <Box component="h4" sx={ environmentCreated ? checkedSx : uncheckedSx }>Step 1: Get a zrok Binary { environmentCreated ? <CheckMarkIcon/> : null }</Box>
                    </Typography>
                </Grid2>
                <Grid2 container sx={{ flexGrow: 1, p: 1 }} alignItems="center">
                    <Typography>
                ...
                <Grid2 container sx={{ flexGrow: 1, p: 1 }} alignItems="center">
                    <Typography>
                        <Box component="h4" sx={ environmentCreated ? checkedSx : uncheckedSx }>Step 2: Enable Your Operating System Shell { environmentCreated ? <CheckMarkIcon/> : null }</Box>
                    </Typography>
                </Grid2>
                <Grid2 container sx={{ flexGrow: 1, p: 1 }} alignItems="center">
                    <Typography>
                ...
                <Grid2 container sx={{ flexGrow: 1, p: 1 }} alignItems="center">
                    <Typography>
                        <pre>
                        $ zrok2 enable {user.token} <ClipboardText text={"zrok2 enable " + user.token}/>
                        </pre>
                    </Typography>
                </Grid2>
                <Grid2 container sx={{ flexGrow: 1, p: 1 }} alignItems="center">
                    <Typography>
                        <Box component="h4" sx={ shareCreated ? checkedSx : uncheckedSx }>Step 3: Share { shareCreated ? <CheckMarkIcon/> : null }</Box>
                    </Typography>
                </Grid2>
                <Grid2 container sx={{ flexGrow: 1, p: 1 }} alignItems="center">
                    <Typography>
                ...
                <Grid2 container sx={{ flexGrow: 1, p: 1 }} alignItems="center">
                    <Typography>
                        <pre>
                        $ zrok2 share public --backend-mode web . <ClipboardText text={"zrok2 share public --backend-mode web ."} />
                        </pre>
                    </Typography>
                </Grid2>
                <Grid2 container sx={{ flexGrow: 1, p: 1 }} alignItems="center">
