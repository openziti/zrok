#!/usr/bin/env bash
#
# postinstall-frontend.bash - Post-installation script for zrok2-frontend package
#

set -euo pipefail

# Package-specific configuration
SERVICE_NAME="zrok2-frontend"
SERVICE_USER="zrok2-frontend"
SERVICE_GROUP="zrok2-frontend"
SERVICE_HOME="/var/lib/zrok2-frontend"
ADDITIONAL_GROUPS=""
