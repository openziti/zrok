...
__export(model_exports, {
  AUTH_SCHEME_BASIC: () => AUTH_SCHEME_BASIC,
  AUTH_SCHEME_NONE: () => AUTH_SCHEME_NONE,
  AUTH_SCHEME_OAUTH: () => AUTH_SCHEME_OAUTH,
  Access: () => Access,
  AccessRequest: () => AccessRequest,
  CADDY_BACKEND_MODE: () => CADDY_BACKEND_MODE,
  Metrics: () => Metrics,
  ...
  UDP_TUNNEL_BACKEND_MODE: () => UDP_TUNNEL_BACKEND_MODE,
  WEB_BACKEND_MODE: () => WEB_BACKEND_MODE,
  zrokBackendModeToOpenApi: () => zrokBackendModeToOpenApi,
  zrokOauthProviderToOpenApi: () => zrokOauthProviderToOpenApi,
  zrokShareModeToOpenApi: () => zrokShareModeToOpenApi
});
