  ...
  invite(_0) {
    return __async(this, arguments, function* (body, options = { headers: {} }) {
      ...
      return interceptorPromise.then(() => {
        ...
        return new Promise((resolve, reject) => {
          localVarRequest(localVarRequestOptions, (error, response, body2) => {
            if (error) {
              reject(error);
            } else {
  ...
  createFrontend(_0) {
    return __async(this, arguments, function* (body, options = { headers: {} }) {
      ...
      return interceptorPromise.then(() => {
        ...
        return new Promise((resolve, reject) => {
          localVarRequest2(localVarRequestOptions, (error, response, body2) => {
            if (error) {
              reject(error);
            } else {
              if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
  ...
  listFrontends() {
    return __async(this, arguments, function* (options = { headers: {} }) {
      ...
      return interceptorPromise.then(() => {
        ...
        return new Promise((resolve, reject) => {
          localVarRequest2(localVarRequestOptions, (error, response, body) => {
            if (error) {
              reject(error);
            } else {
              if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
  ...
  disable(_0) {
    return __async(this, arguments, function* (body, options = { headers: {} }) {
      ...
      return interceptorPromise.then(() => {
        ...
        return new Promise((resolve, reject) => {
          localVarRequest3(localVarRequestOptions, (error, response, body2) => {
            if (error) {
              reject(error);
            } else {
              if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
  ...
  configuration() {
    return __async(this, arguments, function* (options = { headers: {} }) {
      ...
      return interceptorPromise.then(() => {
        ...
        return new Promise((resolve, reject) => {
          localVarRequest4(localVarRequestOptions, (error, response, body) => {
            if (error) {
              reject(error);
            } else {
              if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
