...
Required environment variables:
  ZROK2_API_ENDPOINT  — zrok2 controller URL (e.g. http://zrok.example.com:18080)
...
def account_token(zrok2_endpoint, admin_token):
    ...
    req = LoginRequest(
        email=f"integration-test-{unique_id}@zrok.internal",
...
def enabled_root(tmp_path, account_token, zrok2_endpoint):
    ...
    import zrok2.environment.root as root_mod
