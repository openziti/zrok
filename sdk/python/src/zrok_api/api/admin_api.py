...
class AdminApi:
    ...
    @validate_call
    def get_skip_interstitial_grant(
        self,
        email: StrictStr,
        _request_timeout: Union[
            None,
        ...
        _param = self._get_skip_interstitial_grant_serialize(
            email=email,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GetSkipInterstitialGrant200Response",
            '401': None,
            '404': None,
            '500': None,
        }
    ...
    @validate_call
    def get_skip_interstitial_grant_with_http_info(
        self,
        email: StrictStr,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetSkipInterstitialGrant200Response]:
        """get_skip_interstitial_grant
    ...
    @validate_call
    def get_skip_interstitial_grant_without_preload_content(
        self,
        email: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _get_skip_interstitial_grant_serialize(
        self,
        email,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/skip-interstitial-grant',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def grant_skip_interstitial(
        ...
        _param = self._grant_skip_interstitial_serialize(
            body=body,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def grant_skip_interstitial_with_http_info(
        self,
        body: Optional[Verify200Response] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def grant_skip_interstitial_without_preload_content(
        self,
        body: Optional[Verify200Response] = None,
        _request_timeout: Union[
            None,
    ...
    def _grant_skip_interstitial_serialize(
        self,
        body,
        _request_auth,
        _content_type,
    ...
    @validate_call
    def list_limit_classes(
        self,
        body: Optional[ListLimitClassesRequest] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param body:
        :type body: ListLimitClassesRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._list_limit_classes_serialize(
            body=body,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def list_limit_classes_with_http_info(
        self,
        body: Optional[ListLimitClassesRequest] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def list_limit_classes_without_preload_content(
        self,
        body: Optional[ListLimitClassesRequest] = None,
        _request_timeout: Union[
            None,
    ...
    def _list_limit_classes_serialize(
        self,
        body,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/limit-class/list',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def revoke_skip_interstitial(
        ...
        _param = self._revoke_skip_interstitial_serialize(
            body=body,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def revoke_skip_interstitial_with_http_info(
        self,
        body: Optional[Verify200Response] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def revoke_skip_interstitial_without_preload_content(
        self,
        body: Optional[Verify200Response] = None,
        _request_timeout: Union[
            None,
    ...
    def _revoke_skip_interstitial_serialize(
        self,
        body,
        _request_auth,
        _content_type,
