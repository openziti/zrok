...
class SharesList(BaseModel):
    """
    SharesList
    """ # noqa: E501
    shares: Optional[List[ShareSummary]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "shares": [ShareSummary.from_dict(_item) for _item in obj["shares"]] if obj.get("shares") is not None else None
        })
        return _obj
