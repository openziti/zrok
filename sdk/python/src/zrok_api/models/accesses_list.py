...
class AccessesList(BaseModel):
    """
    AccessesList
    """ # noqa: E501
    accesses: Optional[List[AccessSummary]] = None
    __properties: ClassVar[List[str]] = ["accesses"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "accesses": [AccessSummary.from_dict(_item) for _item in obj["accesses"]] if obj.get("accesses") is not None else None
        })
        return _obj
