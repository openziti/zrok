...
class UpdateShareNameRequest(BaseModel):
    """
    UpdateShareNameRequest
    """ # noqa: E501
    namespace_token: Optional[StrictStr] = Field(default=None, alias="namespaceToken")
    name: Optional[StrictStr] = None
    reserved: Optional[StrictBool] = Field(default=None, description="whether the name should be reserved (true) or released (false)")
    __properties: ClassVar[List[str]] = ["namespaceToken", "name", "reserved"]
