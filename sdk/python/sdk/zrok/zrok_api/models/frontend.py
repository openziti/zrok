...
class Frontend(object):
    ...
    def __init__(self, id=None, frontend_token=None, share_token=None, backend_mode=None, bind_address=None, description=None, z_id=None, created_at=None, updated_at=None, _configuration=None):  # noqa: E501
