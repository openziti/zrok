...
func (o *DeleteShareNameReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 404:
		...
		return nil, result
	case 409:
		result := NewDeleteShareNameConflict()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewDeleteShareNameConflict creates a DeleteShareNameConflict with default headers values
func NewDeleteShareNameConflict() *DeleteShareNameConflict {
	return &DeleteShareNameConflict{}
}

/*
DeleteShareNameConflict describes a response with status code 409, with default header values.

name is still attached to an active share
*/
type DeleteShareNameConflict struct {
	Payload rest_model_zrok.ErrorMessage
}

// IsSuccess returns true when this delete share name conflict response has a 2xx status code
func (o *DeleteShareNameConflict) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this delete share name conflict response has a 3xx status code
func (o *DeleteShareNameConflict) IsRedirect() bool {
	return false
}

// IsClientError returns true when this delete share name conflict response has a 4xx status code
func (o *DeleteShareNameConflict) IsClientError() bool {
	return true
}

// IsServerError returns true when this delete share name conflict response has a 5xx status code
func (o *DeleteShareNameConflict) IsServerError() bool {
	return false
}

// IsCode returns true when this delete share name conflict response a status code equal to that given
func (o *DeleteShareNameConflict) IsCode(code int) bool {
	return code == 409
}

// Code gets the status code for the delete share name conflict response
func (o *DeleteShareNameConflict) Code() int {
	return 409
}

func (o *DeleteShareNameConflict) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /share/name][%d] deleteShareNameConflict %s", 409, payload)
}

func (o *DeleteShareNameConflict) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /share/name][%d] deleteShareNameConflict %s", 409, payload)
}

func (o *DeleteShareNameConflict) GetPayload() rest_model_zrok.ErrorMessage {
	return o.Payload
}

func (o *DeleteShareNameConflict) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
