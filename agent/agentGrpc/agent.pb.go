...
type SharePublicRequest struct {
	...
	OauthNoRedirect      bool                   `protobuf:"varint,11,opt,name=oauthNoRedirect,proto3" json:"oauthNoRedirect,omitempty"`
	unknownFields        protoimpl.UnknownFields
	sizeCache            protoimpl.SizeCache
}
...
func (x *SharePublicRequest) GetOauthNoRedirect() bool {
	if x != nil {
		return x.OauthNoRedirect
	}
	return false
}
...
const file_agent_agentGrpc_agent_proto_rawDesc = "" +
	...
	"\faccessGrants\x18\n" +
	" \x03(\tR\faccessGrants\x12(\n" +
	"\x0foauthNoRedirect\x18\v \x01(\bR\x0foauthNoRedirect\"Y\n" +
