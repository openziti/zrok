...
select id, environment_id, token, z_id, public_name, url_template, private_share_id, bind_address, reserved, permission_mode, description, created_at, updated_at, deleted from frontends_old;
