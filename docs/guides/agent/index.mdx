...
The zrok Agent centralizes management of your zrok shares and accesses. It provides a both web-based and command-line interfaces, and changes how the `zrok share` and `zrok access` commands behave.
