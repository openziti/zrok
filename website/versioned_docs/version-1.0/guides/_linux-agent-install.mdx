...
1. Set up `zrok`'s Linux package repository by following [the Linux install guide](./install/linux.mdx#install-zrok-from-the-repository), or run this one-liner to complete the repo setup and install packages.
