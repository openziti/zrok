...
This downloads the essential Docker Compose project files. Alternatively, clone the repository, for example if you want
to build `zrok2` from source with `compose.build.yml`:
