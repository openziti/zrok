...
[Linux self-hosting guide](@zrokdocs/self-hosting/deployment/linux) — OpenZiti overlay, zrok2
...
[Scaling frontends](@zrokdocs/self-hosting/scaling-frontends) for details.
:::
...
[Linux self-hosting guide](@zrokdocs/self-hosting/deployment/linux).
...
[Linux self-hosting guide](@zrokdocs/self-hosting/deployment/linux#step-12-configure-openziti-metrics-events)
