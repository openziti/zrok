...
```cmd
C:\Program Files\zrok>zrok2 enable <accountToken>
```
...
```cmd
C:\Program Files\zrok>zrok2 agent console
```
...
```
```cmd
C:\Program Files\zrok>nssm set zrokAgent AppStdout C:\Windows\System32\config\systemprofile\.zrok2\agent-stdout.log
```
```cmd
C:\Program Files\zrok>nssm set zrokAgent AppStderr C:\Windows\System32\config\systemprofile\.zrok2\agent-stderr.log
```
...
```cmd
C:\Program Files\zrok>zrok2 disable
```
