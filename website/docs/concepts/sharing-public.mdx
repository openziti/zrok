...
Using `public` shares is easy and is accomplished using the `zrok2 share public` command. Run `zrok2 share public` to see the command-line help and to learn how to use `public` shares.
