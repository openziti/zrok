...
When you run `zrok2 share public` in the foreground, zrok assigns a public URL and opens a full-screen terminal
display showing the URL, share type, and a live feed of incoming requests:
