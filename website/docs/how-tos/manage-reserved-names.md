...
Reserved [names](../concepts/sharing-reserved.md) give your shares a persistent, human-readable identifier that
survives across share sessions. [Namespaces](../concepts/sharing-reserved.md) are the containers that organize
names. This how-to covers the full lifecycle: creating names, using them with shares, managing them, and configuring
a default namespace.
...
starts). See [Reserved names and namespaces](../concepts/sharing-reserved.md) for a full explanation of the
difference.
