...
[Ansible](https://docs.ansible.com/) is an automation tool for running tasks across many servers at once. If you're just installing on one
...
:::info
To run `zrok2` as an always-on service, see the [Linux Agent Service guide](../agent/setup-linux-service.mdx) or the
[Docker guide](../agent/run-docker-agent.mdx).
:::
