...
6. Check the Learn section for more on [share types](@zrokdocs/category/share-types/), [namespaces](@zrokdocs/concepts/namespaces), [environments](@zrokdocs/concepts/environments), etc.
