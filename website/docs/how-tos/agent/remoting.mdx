...
1. Add the identity to your controller configuration:
...
1. Restart your controller. The agent remoting endpoints will become available once it's running.
...
1. Restart the agent. The following message confirms remoting is active:
