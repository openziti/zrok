---
title: Use the zrok Agent
sidebar_label: Use the zrok Agent
sidebar_position: 20
---
...
- Windows - [set up the Windows system service](./windows-service/index.mdx)
- Linux - [install the Linux package `zrok2-agent`](./linux-service.mdx)
...
- The `zrok2 share` and `zrok2 access` commands delegate their operations to the running Agent.
