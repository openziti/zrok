...
3. Click the **I/O** tab and configure log output:
    ...
    Optionally, configure log rotation on the **File rotation** tab:
...
3. With `USERPROFILE` set to `C:\Windows\System32\config\systemprofile`, remove the zrok environment:
