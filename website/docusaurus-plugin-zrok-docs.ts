    ...
    return [
        '@docusaurus/plugin-client-redirects',
        {
            redirects: [
                ...
                { to: `${p}/how-tos/docker-agent/`, from: [`${p}/guides/docker-share/`, `${p}/how-tos/docker-share/`] },
                { to: `${p}/how-tos/docker-agent/`, from: [`${p}/guides/docker-share/docker_private_share_guide`, `${p}/how-tos/docker-share/private-share`] },
                { to: `${p}/how-tos/docker-agent/`, from: [`${p}/guides/docker-share/docker_public_share_guide`, `${p}/how-tos/docker-share/public-share`] },
                ...
                { to: `${p}/self-hosting/linux/`, from: [`${p}/guides/self-hosting/nginx_tls_guide/`, `${p}/guides/self-hosting/linux/nginx`] },
