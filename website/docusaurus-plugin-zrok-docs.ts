    ...
    return [
        '@docusaurus/plugin-client-redirects',
        {
            redirects: [
                ...
                { to: `${p}/how-tos/agent/setup-linux-service`, from: [`${p}/guides/agent/linux-service`, `${p}/how-tos/agent/linux-service`] },
                { to: `${p}/how-tos/agent/enable-agent-remoting`, from: [`${p}/guides/agent/remoting`, `${p}/how-tos/agent/remoting`] },
                ...
                { to: `${p}/self-hosting/deployment/linux`, from: [`${p}/guides/self-hosting/self_hosting_guide`, `${p}/guides/self-hosting/linux`, `${p}/self-hosting/linux/`, `${p}/self-hosting/deployment/linux/`] },
