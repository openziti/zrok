...
type ListSharesHandlerFunc func(ListSharesParams, *rest_model_zrok.Principal) middleware.Responder

// Handle executing the request and returning a response
func (fn ListSharesHandlerFunc) Handle(params ListSharesParams, principal *rest_model_zrok.Principal) middleware.Responder {
	return fn(params, principal)
}

// ListSharesHandler interface for that can handle valid list shares params
type ListSharesHandler interface {
	Handle(ListSharesParams, *rest_model_zrok.Principal) middleware.Responder
}
...
/*
	ListShares swagger:route GET /shares metadata listShares
